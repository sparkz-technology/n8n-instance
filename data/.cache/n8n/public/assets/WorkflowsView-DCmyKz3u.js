import { P as ProjectCardBadge, _ as _sfc_main$4 } from "./ProjectCardBadge-CpBBeiGZ.js";
import { d as defineComponent, Q as useRoute, b as useRouter, a1 as useFoldersStore, r as ref, q as computed, c as useI18n, ab as ProjectTypes, V as VIEWS, h as resolveComponent, i as createElementBlock, g as openBlock, j as createVNode, w as withCtx, n as normalizeClass, k as createBaseVNode, f as createCommentVNode, e as createBlock, m as unref, aq as ResourceType, bB as withModifiers, l as createTextVNode, t as toDisplayString, eZ as _sfc_main$3, _ as _export_sfc, a as useToast, p as useSettingsStore, G as useUIStore, u as useUsersStore, P as useWorkflowsStore, a0 as useProjectsStore, a7 as getResourcePermissions, gA as dateFormat, aE as withDirectives, aF as vShow, ah as WORKFLOW_SHARE_MODAL_KEY, ai as useTelemetry, ap as DUPLICATE_MODAL_KEY, ak as useMessage, al as MODAL_CONFIRM, ar as PROJECT_MOVE_RESOURCE_MODAL, gI as FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX, gJ as ILLEGAL_FOLDER_CHARACTERS, gK as FOLDER_NAME_ONLY_DOTS_REGEX, gL as FOLDER_NAME_MAX_LENGTH, $ as useSourceControlStore, ay as usePostHog, D as useTagsStore, fh as useUsageStore, gM as useInsightsStore, a3 as useDocumentTitle, E as useDebounce, aa as EnterpriseEditionFeature, gN as EASY_AI_WORKFLOW_EXPERIMENT, W as watch, o as onMounted, B as createEventBus, v as onBeforeUnmount, z as debounce, gO as PROJECT_ROOT, ac as useTemplateRef, aZ as createSlots, fe as N8nInputLabel, af as _sfc_main$5, g2 as N8nSelect, F as Fragment, C as renderList, g3 as _sfc_main$6, f2 as N8nHeading, br as N8nText, gP as N8nCard, bE as N8nIcon, gQ as Draggable, ad as InlineRename, gR as DEFAULT_WORKFLOW_PAGE_SIZE, fk as COMMUNITY_PLUS_ENROLLMENT_MODAL } from "./index--ag0tEQM.js";
import { W as WorkflowActivator, _ as __unplugin_components_0 } from "./WorkflowActivator-BaxuVQDl.js";
import { R as ResourcesListLayout } from "./ResourcesListLayout-BRxlSl_6.js";
import { P as ProjectHeader } from "./ProjectHeader-CK7zlcmF.js";
import { u as useProjectPages } from "./useProjectPages-C95x1s47.js";
import { I as InsightsSummary } from "./InsightsSummary-DBfE_9FW.js";
import { g as getEasyAiWorkflowJson } from "./easyAiWorkflowUtils-CWag2afn.js";
import "./useWorkflowActivate-E5Lz7Bjd.js";
...
const actionsContainer = "_actionsContainer_u35tc_123";
const emptyStateCard = "_emptyStateCard_u35tc_139";
const emptyStateCardIcon = "_emptyStateCardIcon_u35tc_152";
const dragging = "_dragging_u35tc_187";
const name = "_name_u35tc_205";
const style0 = {
  actionsContainer,
  "easy-ai-workflow-callout": "_easy-ai-workflow-callout_u35tc_128",
  "callout-trailing-content": "_callout-trailing-content_u35tc_133",
  emptyStateCard,
  emptyStateCardIcon,
  "add-folder-button": "_add-folder-button_u35tc_161",
  "breadcrumbs-container": "_breadcrumbs-container_u35tc_166",
  "breadcrumbs-loading": "_breadcrumbs-loading_u35tc_172",
  "empty-folder-container": "_empty-folder-container_u35tc_178",
  "drag-active": "_drag-active_u35tc_182",
  dragging,
  "drop-active": "_drop-active_u35tc_194",
  "path-separator": "_path-separator_u35tc_199",
  name,
  "pointer-disabled": "_pointer-disabled_u35tc_211"
};
const cssModules = {
  "$style": style0
};
