const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-Bgs-It2X.js","assets/index--ag0tEQM.js","assets/index-B-xWz5mo.css","assets/NodeCreator-Cp8Apzva.css"])))=>i.map(i=>d[i]);
import { dt as useNodeCreatorStore, bt as useNodeTypesStore, q as computed, c as useI18n, P as useWorkflowsStore, hm as MANUAL_TRIGGER_NODE_TYPE, hn as CHAIN_LLM_LANGCHAIN_NODE_TYPE, bb as NodeConnectionTypes, bk as CHAT_TRIGGER_NODE_TYPE, ho as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, hp as OPEN_AI_NODE_TYPE, hq as SPLIT_IN_BATCHES_NODE_TYPE, hr as NO_OP_NODE_TYPE, hs as WEBHOOK_NODE_TYPE, ht as SCHEDULE_TRIGGER_NODE_TYPE, hu as transformNodeType, aT as useExternalHooks, Z as useCanvasStore, hv as AI_CATEGORY_LANGUAGE_MODELS, hw as QA_CHAIN_NODE_TYPE, hx as AGENT_NODE_TYPE, hy as BASIC_CHAIN_NODE_TYPE, hz as OPEN_AI_ASSISTANT_NODE_TYPE, aC as STICKY_NODE_TYPE, hA as sortNodeCreateElements, hB as TRIGGER_NODE_CREATOR_VIEW, du as NODE_CREATOR_OPEN_SOURCES, d as defineComponent, G as useUIStore, r as ref, c1 as useThrottleFn, o as onMounted, v as onBeforeUnmount, h as resolveComponent, i as createElementBlock, g as openBlock, f as createCommentVNode, e as createBlock, n as normalizeClass, k as createBaseVNode, j as createVNode, w as withCtx, m as unref, bY as KeyboardShortcutTooltip, e8 as defineAsyncComponent, dD as Suspense, F as Fragment, as as __vitePreload, hC as getMidCanvasPosition, hD as DEFAULT_STICKY_WIDTH, hE as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index--ag0tEQM.js";
const useActions = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-Bgs-It2X.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const props = __props;
    const emit = __emit;
