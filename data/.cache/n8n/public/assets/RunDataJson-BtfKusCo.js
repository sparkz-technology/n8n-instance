const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-CglQIRT9.js","assets/index--ag0tEQM.js","assets/index-B-xWz5mo.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-DrgwFS0W.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, aw as useNDVStore, r as ref, cN as useElementSize, q as computed, fR as executionDataToJson, i as createElementBlock, g as openBlock, e as createBlock, j as createVNode, w as withCtx, f as createCommentVNode, m as unref, e8 as defineAsyncComponent, dD as Suspense, he as TextWithHighlights, n as normalizeClass, hf as MappingPill, gQ as Draggable, as as __vitePreload, hg as shorten, hj as getMappedExpression, hk as isString, hl as nonExistingJsonPath, aT as useExternalHooks, ai as useTelemetry, _ as _export_sfc } from "./index--ag0tEQM.js";
import { a as VueJsonPretty } from "./RunData-D6YmSB6p.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-CglQIRT9.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
